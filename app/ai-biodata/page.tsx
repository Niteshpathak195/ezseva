...
// ─────────────────────────────────────────────────────────────────────────────
// EzSeva — AI Biodata Maker (Coming Soon)
...
const ACCENT    = "#D97706";
const GRAD_FROM = "#D97706";
const GRAD_TO   = "#DC2626";
...
/* ══════════════════════════════════════════════
   MAIN PAGE
══════════════════════════════════════════════ */
export default function AIBiodataPage() {
        ...
        <section style={{
          ...
          <div style={{ position: "relative", maxWidth: "620px", margin: "0 auto" }}>
            ...
            <p style={{ fontSize: "17px", fontWeight: 700, color: ACCENT, marginBottom: "12px", letterSpacing: "-0.2px" }}>
              Marriage biodata — beautiful, ready to share.
            </p>
...
export const metadata = {
  ...
  description: "Create a professional Indian marriage biodata with AI. Beautiful templates, horoscope section, PDF download. Launching soon on EzSeva. Free forever.",
  openGraph: {
    title: "AI Biodata Maker — Coming Soon | EzSeva",
    description: "Marriage biodata — beautiful, ready to share. Launching soon.",
    url: "https://ezseva.in/ai-biodata",
    siteName: "EzSeva",
  },
